...
function factory() {
    ...
    var tuple = new ((_a = ClassMap[values.length]).bind.apply(_a, [null].concat(values)))();
    tuple.__proto__.__proto__ = Object.create(new (Array.bind.apply(Array, [void 0].concat(values)))());
